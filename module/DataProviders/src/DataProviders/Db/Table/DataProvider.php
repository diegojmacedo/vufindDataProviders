<?php
/**
 * Table Definition for data_provider
 *
 * PHP version 5
 *
 ...
 */
namespace DataProviders\Db\Table;
 ...
 * @category VuFind2
 * @package  Db_Table
 * @author   Diego Macêdo <diegojmacedo@gmail.com>
 * @license  http://opensource.org/licenses/gpl-2.0.php GNU General Public License
 * @link     http://vufind.org   Main Site
 */
class DataProvider extends \VuFind\Db\Table\Gateway
{
    /**
     * Constructor
     */
    ...
    {
        parent::__construct('data_provider', 'DataProviders\Db\Row\DataProvider');
    }
