<?php
/**
 * Row Definition for data_provider
 *
 * PHP version 5
 *
 ...
 */
namespace DataProviders\Db\Row;
 ...
 * @link     http://vufind.org   Main Site
 */
class DataProvider extends \VuFind\Db\Row\RowGateway
{
    /**
     * Constructor
     *
    ...
    {
        parent::__construct('id', 'data_provider', $adapter);
    }
